...
class FR3ReachEnv(gym.Env):
    ...
    def __init__(self, render_mode=None, max_steps=200, n_substeps=5):
        super().__init__()

        # 加载MuJoCo模型（FR3场景）
        model_path = os.path.join(os.path.dirname(__file__), "models", "fr3_reach.xml")
        ...
        self.ee_vel_threshold = 0.02  # m/s，末端速度阈值
